...
class DLM_ResponseMatrix {
  ...
  public:
    DLM_ResponseMatrix(DLM_Histo<double> &ch, const DLM_Histo<float> *hs, const DLM_Histo<float> *hr,
                       const bool &ia = false);
  ...
  private:
    ...
    double BilinearInterpolation(const double &x0, const double &y0, const double &x1, const double &y1,
