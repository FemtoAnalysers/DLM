...
DLM_StefanoPotentials::DLM_StefanoPotentials(const int &WhichPot, const int &XMN, const int &GAM, const int &RHO,
                                             const int &CHI, const int &OMG, const int &FTP)
    : m_pi(138.03), m_pi_not(134.98), m_pi_plus(139.570), m_n(939.565), g_a(1.267), g_a_Tre(1.29), f_pi(92.4),
      pi(3.1415926535897), hc197(197.327053), g34(1.22541670246517), EGM_C1(-0.00081), EGM_C3(-0.0034), EGM_C4(0.0034),
...
double DLM_StefanoPotentials::yc(const double &t, const double &x) { return exp(-t) / x; }
double DLM_StefanoPotentials::yt(const double &t, const double &x) {
    return (1. + 3. / t + 3. / pow(t, 2)) * exp(-t) / x;
}
double DLM_StefanoPotentials::yls(const double &t, const double &x) { return -(1. + t) * exp(-t) / pow(x, 3); }
double DLM_StefanoPotentials::yl2(const double &t, const double &x) { return (1. + 2. / t) * exp(-t) / pow(x, 3); }
double DLM_StefanoPotentials::pc(const double &t) { return exp(-t) / t; }
double DLM_StefanoPotentials::pt(const double &t) { return (1. + 3. / t + 3. / pow(t, 2)); }
double DLM_StefanoPotentials::pls(const double &t) { return (1. + 1. / t) / t; }
double DLM_StefanoPotentials::pso2(const double &t) { return (1. + 3. / t + 3. / pow(t, 2)) / pow(t, 2); }
...
void DLM_StefanoPotentials::setpot() {
    ...
    pgvb01[0] = 0.0026851393;
    pgvb01[1] = 0.051092455;
    pgvb01[2] = -0.84264258;
    pgvb01[3] = 14.736312;
    pgvb01[4] = -145.21993;
    pgvb01[5] = 841.58389;
    ...
    pgvb11[0] = -0.00089504644;
    pgvb11[1] = 0.037488481;
    pgvb11[2] = -0.89373089;
    pgvb11[3] = 14.123475;
    pgvb11[4] = -146.60152;
    pgvb11[5] = 841.91462;
    ...
    pgvb00[0] = -0.0085980096;
    pgvb00[1] = 0.026814385;
    pgvb00[2] = -1.3280693;
    pgvb00[3] = 10.324289;
    pgvb00[4] = -115.27067;
    pgvb00[5] = 694.56175;
    ...
    pgvb10[0] = 0.0028660032;
    pgvb10[1] = -0.00081798046;
    pgvb10[2] = -0.53314560;
    pgvb10[3] = 0.83162030;
    pgvb10[4] = -31.192395;
    pgvb10[5] = 300.41384;
    ...
    if (lpot == 0) {
        ...
        pgvt1[10] = pow(pm1[10], 3) * (pow(pm1[11], 2) * tumt1 - sumt1) / (pow(pm1[10], 2) - pow(pm1[11], 2));
        pgvt1[11] = pow(pm1[11], 3) * (pow(pm1[10], 2) * tumt1 - sumt1) / (pow(pm1[11], 2) - pow(pm1[10], 2));
        pgvt0[10] = pow(pm0[10], 3) * (pow(pm0[11], 2) * tumt0 - sumt0) / (pow(pm0[10], 2) - pow(pm0[11], 2));
        pgvt0[11] = pow(pm0[11], 3) * (pow(pm0[10], 2) * tumt0 - sumt0) / (pow(pm0[11], 2) - pow(pm0[10], 2));
        pgvls1[10] = pow(pm1[10], 3) * (pow(pm1[11], 2) * tumls1 - sumls1) / (pow(pm1[10], 2) - pow(pm1[11], 2));
        pgvls1[11] = pow(pm1[11], 3) * (pow(pm1[10], 2) * tumls1 - sumls1) / (pow(pm1[11], 2) - pow(pm1[10], 2));
        pgvls0[10] = pow(pm0[10], 3) * (pow(pm0[11], 2) * tumls0 - sumls0) / (pow(pm0[10], 2) - pow(pm0[11], 2));
        pgvls0[11] = pow(pm0[11], 3) * (pow(pm0[10], 2) * tumls0 - sumls0) / (pow(pm0[11], 2) - pow(pm0[10], 2));
        ...
        pgvso21[9] =
            pow(pm1[9], 5) *
            (-pow(pm1[10], 2) * pow(pm1[11], 2) * uumso21 + (pow(pm1[10], 2) + pow(pm1[11], 2)) * tumso21 - sumso21) /
            ((pow(pm1[11], 2) - pow(pm1[9], 2)) * (pow(pm1[10], 2) - pow(pm1[9], 2)));
        pgvso21[10] =
            pow(pm1[10], 5) *
            (-pow(pm1[11], 2) * pow(pm1[9], 2) * uumso21 + (pow(pm1[11], 2) + pow(pm1[9], 2)) * tumso21 - sumso21) /
            ((pow(pm1[9], 2) - pow(pm1[10], 2)) * (pow(pm1[11], 2) - pow(pm1[10], 2)));
        pgvso21[11] =
            pow(pm1[11], 5) *
            (-pow(pm1[9], 2) * pow(pm1[10], 2) * uumso21 + (pow(pm1[9], 2) + pow(pm1[10], 2)) * tumso21 - sumso21) /
            ((pow(pm1[10], 2) - pow(pm1[11], 2)) * (pow(pm1[9], 2) - pow(pm1[11], 2)));
        pgvso20[9] =
            pow(pm0[9], 5) *
            (-pow(pm0[10], 2) * pow(pm0[11], 2) * uumso20 + (pow(pm0[10], 2) + pow(pm0[11], 2)) * tumso20 - sumso20) /
            ((pow(pm0[11], 2) - pow(pm0[9], 2)) * (pow(pm0[10], 2) - pow(pm0[9], 2)));
        pgvso20[10] =
            pow(pm0[10], 5) *
            (-pow(pm0[11], 2) * pow(pm0[9], 2) * uumso20 + (pow(pm0[11], 2) + pow(pm0[9], 2)) * tumso20 - sumso20) /
            ((pow(pm0[9], 2) - pow(pm0[10], 2)) * (pow(pm0[11], 2) - pow(pm0[10], 2)));
        pgvso20[11] =
            pow(pm0[11], 5) *
            (-pow(pm0[9], 2) * pow(pm0[10], 2) * uumso20 + (pow(pm0[9], 2) + pow(pm0[10], 2)) * tumso20 - sumso20) /
...
void DLM_StefanoPotentials::ArgonneV18() {
    ...
    if (lpot <= 15) {
        ...
        p01np = -10.57598 * tpi2 + 2273.0877 * wsp - 289.7548 * wsx2 - 3. * (-ypi0p + 2. * ypicp);
        p01nn = -11.24918 * tpi2 + 2443.1614 * wsp - 278.5780 * wsx2 - 3. * ypi0p;
        pl201 = 0.12622 * tpi2 + 23.4445 * wsp - 13.5987 * wsx2;
        p00 = -2.14060 * tpi2 + 1000.2218 * wsp - 167.8362 * wsx2 - 3. * (-ypi0p - 2. * ypicp);
        ...
        p01np = -11.62496 * tpi2 + 1724.8767 * wsp - 116.8103 * wsx2 - 3 * (-ypi0p + 2 * ypicp);
        p01nn = -11.28159 * tpi2 + 1733.0438 * wsp - 290.3768 * wsx2 - 3 * ypi0p;
        pl201 = 0.12387 * tpi2 + 24.9311 * wsp - 14.7805 * wsx2;
        p00 = -1.94411 * tpi2 + 808.3897 * wsp - 277.7773 * wsx2 - 3 * (-ypi0p - 2 * ypicp);
...
void DLM_StefanoPotentials::ArgonneV18p() {
    ...
    if (rr <= small) {
        ...
        tpidp = (tdpVar * yVar + 2. * tpVar * ypVar + tVar * ydpVar) * pow(rcut, 2) +
                4. * (tpVar * yVar + tVar * ypVar) * rcut * rcutp + 2. * tVar * yVar * (rcut * rcutdp + pow(rcutp, 2));
    }
    ypi0 = fsq * ypi0;
    ypic = fsq * ypic;
    tpi0 = fsq * tpi0;
    ...
    p01np = -10.812190 * tpi2 + 2816.4190 * wsm + 1002.5300 * wsx2 - 3 * (-ypi0p + 2 * ypicp);
    p01nn = -10.518030 * tpi2 + 2832.4903 * wsm + 651.1945 * wsx2 - 3 * ypi0p;
    pl201 = 0.134747 * tpi2 - 9.4691 * wsm;
    p00 = -4.739629 * tpi2 + 1121.2225 * wsm + 2764.3395 * wsx2 - 3 * (-ypi0p - 2 * ypicp);
...
void DLM_StefanoPotentials::SuperSoftCoreV14() {
    ...
    hrVar = 10.463;
    p11 =
        144.83 * exp(-rr4 / pow(0.88787, 2)) + (-241.34 * yc(3.3788 * xVar, xVar) + (hrVar / 3) * yc(xVar, xVar)) * rc4;
    p10 = 215.32 * exp(-rr4 / pow(0.85807, 2)) + (-883.6 * yc(3.5042 * xVar, xVar) - hrVar * yc(xVar, xVar)) * rc4;
    p01 = 375. * exp(-rr4 / pow(0.47552, 2)) + (-1001.6 * yc(3.6071 * xVar, xVar) - hrVar * yc(xVar, xVar)) * rc4;
    p00 = 75.653 * exp(-rr4 / pow(3.0000, 2)) + (-286.26 * yc(2.0254 * xVar, xVar) + 3 * hrVar * yc(xVar, xVar)) * rc4;
    pt1 = 36. * exp(-rr4 / pow(1.0805, 2)) + (-110. * yt(3.9529 * xVar, xVar) + (hrVar / 3) * yt(xVar, xVar)) * rc6;
    pt0 = -58.951 * exp(-rr4 / pow(1.3171, 2)) + (395.18 * yt(4.3098 * xVar, xVar) - hrVar * yt(xVar, xVar)) * rc6;
...
void DLM_StefanoPotentials::cheft(const double &rr) {
    ...
    pre_not = (pow(m_pi_not, 3) / (12.0 * pi)) * pow(g_a_Tre / (2 * f_pi), 2) * exp(-x_not) / x_not;
    x_plus = m_pi_plus * rad / hc197;
    pre_plus = (pow(m_pi_plus, 3) / (12.0 * pi)) * pow(g_a_Tre / (2 * f_pi), 2) * exp(-x_plus) / x_plus;
    ...
    ten_not = (1.0 - del_r) * pre_not * (1.0 + 3.0 / x_not + 3.0 / pow(x_not, 2));
    ten_plus = (1.0 - del_r) * pre_plus * (1.0 + 3.0 / x_plus + 3.0 / pow(x_plus, 2));
...
double DLM_StefanoPotentials::Eval(const double &Radius, const int &Spin, const int &Spin3, const int &IsoSpin,
                                   const int &IsoSpin3) {
    EvalValue = 0;
    pot(Radius, 0);
    // pp
...
double DLM_StefanoPotentials::Eval_PWprojector(const double &Radius, const int &IsoSpin, const int &PartType1,
                                               const int &PartType2, const int &Spin, const int &AngMom,
                                               const int &TotMom, const int &DlmFlag) {
    pot(Radius, 0);
    ...
    double vc = vv[0] + t1dt2 * vv[1] + s1ds2 * vv[2] + s1ds2 * t1dt2 * vv[3] + t12 * vv[14] + s1ds2 * t12 * vv[15] +
                (t1z + t2z) * vv[17];
    ...
    else if (AngMom == (TotMom - 1) && DlmFlag == 1) {
        s12 = -1. * double(TotMom + 1) / double(2 * TotMom + 1);
    ...
    if (Spin == 1 && AngMom == (TotMom - 1)) {
        if (DlmFlag == 2)
            ...
            RETURN_VAL = vc + s12p * vt + lsp * vls + (AngMom + 2.) * (AngMom + 3.) * vl2 + lsp * lsp * vls2;
    }
...
// DlmFlag : 3 => take the coupled channel, but compute only the off-diagonal term
// DlmFlag : 4 => take the coupled channel, but compute only the second diagonal term
double DLM_StefanoPotentials::Eval_PWprojector_pp(const double &Radius, const int &Spin, const int &AngMom,
                                                  const int &TotMom, const int &DlmFlag) {
    pot(Radius, 0);
...
void DLM_StefanoPotentials::PotentialName(const int &WhichPot, char *Name) {
    switch (WhichPot) {
    case 1:
        strcpy(Name, "Malfliet-Tjon");
        break;
    case 2:
        strcpy(Name, "Reid V8");
        break;
    case 3:
        strcpy(Name, "Urbana V14");
        break;
    case 4:
        strcpy(Name, "Argonne V8*");
        break;
    case 5:
        strcpy(Name, "Argonne V9");
        break;
    case 6:
        strcpy(Name, "Argonne V14");
        break;
    case 7:
        strcpy(Name, "Argonne V18-csbl");
        break;
    case 8:
        strcpy(Name, "Argonne V18-csbs");
        break;
    case 9:
        strcpy(Name, "Argonne V18");
        break;
    case 10:
        strcpy(Name, "Argonne V8");
        break;
    case 11:
        strcpy(Name, "Argonne V6");
        break;
    case 12:
        strcpy(Name, "Argonne V4");
        break;
    case 13:
        strcpy(Name, "Argonne V2");
        break;
    case 14:
        strcpy(Name, "Argonne V1");
        break;
    case 15:
        strcpy(Name, "Argonne VX");
        break;
    case 16:
        strcpy(Name, "Argonne V18p");
        break;
    case 17:
        strcpy(Name, "Argonne V18pq");
        break;
    case 18:
        strcpy(Name, "Super-soft core V14");
        break;
    case 19:
        strcpy(Name, "Super-soft core V8*");
        break;
    case 20:
        strcpy(Name, "Paris");
        break;
    case 21:
        strcpy(Name, "Argonne V18 1.9");
        break;
    case 22:
        strcpy(Name, "Argonne V8 1.9");
        break;
    case 23:
        strcpy(Name, "Argonne V18 1.7");
        break;
    case 24:
        strcpy(Name, "Argonne V8 1.7");
        break;
    case 112:
        strcpy(Name, "LO, R0=1.0");
        break;
    case 113:
        strcpy(Name, "NLO, R0=1.0");
        break;
    case 114:
        strcpy(Name, "N2LO, R0=1.0");
        break;
    case 122:
        strcpy(Name, "LO, R0=1.2");
        break;
    case 123:
        strcpy(Name, "NLO, R0=1.2");
        break;
    case 124:
        strcpy(Name, "N2LO, R0=1.2");
        break;
    default:
