...
class DLM_SmearedCats {
  ...
  public:
    ...
    void SetUseLednicky(const unsigned &WhichNr, const int &val, const double &grad, const double &ScattLen1,
                        const double &EffRan1, const double &ScattLen3, const double &EffRan3, const double &ares,
                        const double &arad, const double &lambda0);
