...
double DLM_FITTER2_FUNCTION_SPLINE3(double *xVal, double *pars) {
    ...
    if (NumKnots > MAX_KNOTS)
        NumKnots = MAX_KNOTS;
    if (!DLM_FITTER2_ARRAY_SPLINE3_X)
        DLM_FITTER2_ARRAY_SPLINE3_X = new double[MAX_KNOTS];
    if (!DLM_FITTER2_ARRAY_SPLINE3_Y)
        DLM_FITTER2_ARRAY_SPLINE3_Y = new double[MAX_KNOTS];
    for (int iKnot = 0; iKnot < NumKnots; iKnot++) {
        ...
        if (DLM_FITTER2_ARRAY_SPLINE3_Y[iKnot] == 1e6 && iKnot)
            DLM_FITTER2_ARRAY_SPLINE3_Y[iKnot] = pars[3 + NumKnots + iKnot - 1];
    }
...
DLM_Fitter1::DLM_Fitter1(const unsigned &maxnumsyst) : MaxNumSyst(maxnumsyst), NumPar(26 + 25), NumRangePar(4) {
    ...
    for (unsigned uPar = 0; uPar < MaxNumSyst * NumPar; uPar++)
        ParentParameter[uPar] = -1;
    ...
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        ...
        ParValue[uSyst][p_a] = 1;
        ParDownLimit[uSyst][p_a] = 0.5;
        ParUpLimit[uSyst][p_a] = 2;
        ParValue[uSyst][p_b] = 1e-3;
        ParDownLimit[uSyst][p_b] = 1e-5;
        ParUpLimit[uSyst][p_b] = 1;
        ParValue[uSyst][p_c] = 0;
        ParDownLimit[uSyst][p_c] = 0;
        ParUpLimit[uSyst][p_c] = 0;
        ParValue[uSyst][p_3] = 0;
        ParDownLimit[uSyst][p_3] = 0;
        ParUpLimit[uSyst][p_3] = 0;
        ParValue[uSyst][p_4] = 0;
        ParDownLimit[uSyst][p_4] = 0;
        ParUpLimit[uSyst][p_4] = 0;
        FixPar[uSyst][p_c] = true;
        FixPar[uSyst][p_3] = true;
        FixPar[uSyst][p_4] = true;
        ParValue[uSyst][p_ab_0] = 0;
        ParDownLimit[uSyst][p_ab_0] = 0;
        ParUpLimit[uSyst][p_ab_0] = 0;
        ParValue[uSyst][p_ab_1] = 0;
        ParDownLimit[uSyst][p_ab_1] = 0;
        ParUpLimit[uSyst][p_ab_1] = 0;
        ParValue[uSyst][p_ab_2] = 0;
        ParDownLimit[uSyst][p_ab_2] = 0;
        ParUpLimit[uSyst][p_ab_2] = 0;
        ParValue[uSyst][p_ab_3] = 0;
        ParDownLimit[uSyst][p_ab_3] = 0;
        ParUpLimit[uSyst][p_ab_3] = 0;
        ParValue[uSyst][p_ab_4] = 0;
        ParDownLimit[uSyst][p_ab_4] = 0;
        ParUpLimit[uSyst][p_ab_4] = 0;
        ParValue[uSyst][p_ab_5] = 0;
        ParDownLimit[uSyst][p_ab_5] = 0;
        ParUpLimit[uSyst][p_ab_5] = 0;
        ParValue[uSyst][p_ab_6] = 0;
        ParDownLimit[uSyst][p_ab_6] = 0;
        ParUpLimit[uSyst][p_ab_6] = 0;
        ...
        FixPar[uSyst][p_ab_6] = true;

        ParValue[uSyst][p_sor0] = 1.5;
        ParDownLimit[uSyst][p_sor0] = 1;
        ParUpLimit[uSyst][p_sor0] = 2.5;
        ParValue[uSyst][p_sor1] = 0;
        ParValue[uSyst][p_sor2] = 0;
        ParValue[uSyst][p_sor3] = 0;
        ParValue[uSyst][p_sor4] = 0;
        ParValue[uSyst][p_sor5] = 0;
        FixPar[uSyst][p_sor0] = true;
        FixPar[uSyst][p_sor1] = true;
        FixPar[uSyst][p_sor2] = true;
        FixPar[uSyst][p_sor3] = true;
        FixPar[uSyst][p_sor4] = true;
        FixPar[uSyst][p_sor5] = true;
        ParValue[uSyst][p_Cl] = 1;
        ParDownLimit[uSyst][p_Cl] = 0.75;
        ParUpLimit[uSyst][p_Cl] = 1.25;
        ParValue[uSyst][p_kc] = 300;
        ParDownLimit[uSyst][p_kc] = 150;
        ParUpLimit[uSyst][p_kc] = 900;
        ParValue[uSyst][p_pot0] = 0;
        ParValue[uSyst][p_pot1] = 0;
        ParValue[uSyst][p_pot2] = 0;
        ParValue[uSyst][p_pot3] = 0;
        ParValue[uSyst][p_pot4] = 0;
        ParValue[uSyst][p_pot5] = 0;
        FixPar[uSyst][p_pot0] = true;
        FixPar[uSyst][p_pot1] = true;
        FixPar[uSyst][p_pot2] = true;
        FixPar[uSyst][p_pot3] = true;
        FixPar[uSyst][p_pot4] = true;
        FixPar[uSyst][p_pot5] = true;
        for (int iSpline = 0; iSpline < 25; iSpline++) {
            ParValue[uSyst][p_spline + iSpline] = 0;
            FixPar[uSyst][p_spline + iSpline] = true;
        }
        // FitBL[uSyst] = new
        // TF1(TString::Format("FitBL%u",uSyst),"[0]+[1]*x+[2]*x*x",FitRange[uSyst][kl],FitRange[uSyst][kmax]);
        FitBL[uSyst] = NULL;
    }
...
DLM_Fitter1::~DLM_Fitter1() {
    ...
    delete[] FixPar;
    FixPar = NULL;
    delete[] SeparateBaseLineFit;
    SeparateBaseLineFit = NULL;
    delete[] FullCkForBaseline;
    FullCkForBaseline = NULL;
    delete FitBL;
    FitBL = NULL;
    ...
    if (CumulativeNumBinsSyst) {
        delete[] CumulativeNumBinsSyst;
        CumulativeNumBinsSyst = NULL;
    }
    ...
    if (ParentParameter) {
        delete[] ParentParameter;
        ParentParameter = NULL;
    }
    if (PotentialSystems) {
        delete[] PotentialSystems;
        PotentialSystems = NULL;
    }
    if (ParentPotential) {
        delete[] ParentPotential;
        ParentPotential = NULL;
    }
}

// void DLM_Fitter1::TEST1(const unsigned& WhichSyst, TH1F* histo, const double& FromMeV ,
//                    DLM_CkDecomp* decomp, const double& KMIN, const double& KFEMTO, const double& KLINEAR, const
//                    double& KMAX){
// HistoToFit[0] = new TH1F(TString::Format("HistoToFit%u",0),TString::Format("HistoToFit%u",0),10,0,1);
// return;
// }

void DLM_Fitter1::SetSystem(const unsigned &WhichSyst, const TH1F &histo, const double &FromMeV, DLM_CkDecomp &decomp,
                            const double &KMIN, const double &KFEMTO, const double &KLINEAR, const double &KMAX) {
    ...
    if (KMIN > KFEMTO || KMIN > KLINEAR || KMIN > KMAX || KFEMTO > KLINEAR || KFEMTO > KMAX || KLINEAR > KMAX) {
    ...
    // TH1F* h1 = new
    // TH1F(TString::Format("HistoToFit%u",WhichSyst),TString::Format("HistoToFit%u",WhichSyst),NumBins,Bins);
    HistoToFit[WhichSyst] = new TH1F(TString::Format("HistoToFit%u_%p", WhichSyst, this),
                                     TString::Format("HistoToFit%u_%p", WhichSyst, this), NumBins, Bins);
    // HistoToFit[WhichSyst] = new
    // TH1F(TString::Format("HistoToFit%u",WhichSyst),TString::Format("HistoToFit%u",WhichSyst),10,0,1);
...
void DLM_Fitter1::AddSameSource(const TString &System, const TString &EqualTo, const int &numpars) {
    ...
    bool Trouble = false;
    for (unsigned uEntry = 0; uEntry < NumSourceMapEntries; uEntry++) {
        if (SameSourceMap[uEntry][0] == EqualTo) {
            Trouble = true;
            break;
        }
        // We also make sure that one system is not set equal to some other system more than once
        if (SameSourceMap[uEntry][0] == System) {
            Trouble = true;
            break;
        }
        if (SameSourceMap[uEntry][1] == System) {
            Trouble = true;
            break;
        }
    }
...
void DLM_Fitter1::AddSamePotential(const TString &System, const TString &EqualTo, const int &numpars) {
    ...
    bool Trouble = false;
    for (unsigned uEntry = 0; uEntry < NumPotentialMapEntries; uEntry++) {
        if (SamePotentialMap[uEntry][0] == EqualTo) {
            Trouble = true;
            break;
        }
        // We also make sure that one system is not set equal to some other system more than once
        if (SamePotentialMap[uEntry][0] == System) {
            Trouble = true;
            break;
        }
        if (SamePotentialMap[uEntry][1] == System) {
            Trouble = true;
            break;
        }
    }
...
void DLM_Fitter1::AddSameParameter(const TString &System, const unsigned &WhichPar, const TString &ParentSystem,
                                   const unsigned &ParentPar) {
    ...
    // this guy is -1 if the system has no parent, else it is WhichParent*NumPar+ParentPar (i.e. the id of the parent
    // parameter)
...
// return -2 is error
int DLM_Fitter1::GetBaseParameter(const int &WhichSyst, const int &WhichPar, int &ParentSystem, int &ParentPar,
                                  const int &StartSystem, const int &StartPar) {
    if (WhichSyst < 0) {
        return -2;
    }
    if (WhichPar >= int(NumPar)) {
    ...
    if (ParentParameter[WhichSyst * NumPar + WhichPar] == -1) {
        ...
        // return
        // GetBaseParameter(GetSystem((WhichSyst*NumPar+WhichPar)/WhichSyst),(WhichSyst*NumPar+WhichPar)%(WhichSyst*NumPar),ParentSystem,ParentPar,StartSystem,StartPar);
        ...
        if (NextSystem == StartSystem && NextPar == StartPar)
            return -2;
...
int DLM_Fitter1::GetBaseParameter(const TString &System, const int &WhichPar, TString &ParentSystem, int &ParentPar,
                                  const TString &StartSystem, const int &StartPar) {
    int WhichSyst = GetSystem(System);
    if (WhichSyst < 0) {
        return -2;
    }
...
void DLM_Fitter1::SetMultBaselineType(const int &TYPE) { TypeMultBl = TYPE; }
void DLM_Fitter1::SetAddBaselineType(const int &TYPE) { TypeAddBl = TYPE; }

void DLM_Fitter1::SetParameter(const unsigned &WhichSyst, const unsigned &WhichPar, const double &Value,
                               const double &ValueDown, const double &ValueUp) {
    if (WhichSyst >= MaxNumSyst)
        return;
    if (WhichPar >= NumPar)
        return;
...
void DLM_Fitter1::SetParameter(const TString &WhichSyst, const unsigned &WhichPar, const double &Value,
                               const double &ValueDown, const double &ValueUp) {
    char *buffer = new char[128];
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        if (SystemToFit[uSyst]) {
...
double DLM_Fitter1::GetChi2() { return FitGlobal->GetChisquare(); }
int DLM_Fitter1::GetNdf() { return FitGlobal->GetNDF(); }
double DLM_Fitter1::GetChi2Ndf() { return GetChi2() / double(GetNdf()); }
double DLM_Fitter1::GetPval() { return FitGlobal->GetProb(); }
/*
...
void DLM_Fitter1::GetMultBaselineGraph(const unsigned &WhichSyst, TGraph &OutGraph, const bool &DataBinning) {
    ...
    if (DataBinning) {
        ...
        for (unsigned uBin = 0; uBin < NumBinsSyst[WhichSyst]; uBin++) {
            Momentum = GlobalToMomentum[GlobalBinShift + uBin];
            double BlVal = GetParameter(WhichSyst, p_a) + GetParameter(WhichSyst, p_b) * Momentum +
                           GetParameter(WhichSyst, p_c) * Momentum * Momentum +
                           GetParameter(WhichSyst, p_3) * pow(Momentum, 3.) +
                           GetParameter(WhichSyst, p_4) * pow(Momentum, 4.);
...
void DLM_Fitter1::SetOutputDir(const TString &outdirname) { OutputDirName = outdirname; }
...
void DLM_Fitter1::RemoveNegativeCk(const bool &yesno) { RemoveNegCk = yesno; }
    ...
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        if (SystemToFit[uSyst]) {
            for (unsigned uBin = 0; uBin < SystemToFit[uSyst]->GetCk()->GetNbins(); uBin++) {
                // printf("
                // SystemToFit[uSyst]->GetCk()->GetBinContent(%u)=%f\n",uBin,SystemToFit[uSyst]->GetCk()->GetBinContent(uBin));
                if (SystemToFit[uSyst]->GetCk()->GetBinContent(uBin) < 0)
                    return true;
            }
        }
    }
...
TF1 *DLM_Fitter1::GetFit() { return FitGlobal; }
TF1 *DLM_Fitter1::GetBaselineFit(const unsigned &WhichSyst) const {
    if (WhichSyst >= MaxNumSyst)
        return NULL;
    return FitBL[WhichSyst];
}
const TH1F *DLM_Fitter1::GetGlobalHisto() const { return HistoGlobal; }
...
TGraphErrors *DLM_Fitter1::GetUnfoldedCk(const unsigned &WhichSyst, const unsigned &Regulator,
                                         const TString &SaveIntoFile) const {
    return NULL;
    /*
    ...
    //usleep(1000e3);
        for(unsigned uIter=0; uIter<NumIter; uIter++){
            ...
            if(uIter==0){
                ...
                //Get the computed regularized covariance matrix (always corresponding to total uncertainty passed in
    constructor) and add uncertainties from finite MC statistics. utaucov =
    (TH2D*)tsvdunf->GetXtau()->Clone("tsvdunf_utaucov"); utaucov->Add( uadetcov );
    ...
    //usleep(1000e3);
        for(int uBin=0; uBin<unf_NumBins; uBin++){
            //grUnfoldedData->SetPointError(uBin,0,hRESULT->ProjectionY("hRESULT_ProjectionY",
    uBin+1,uBin+1)->GetStdDev());
        }
    //printf("And again %s\n",SaveIntoFile.Data());
    //usleep(1000e3);
...
void DLM_Fitter1::GoBabyGo(const bool &show_fit_info) {
    ...
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        if (!SeparateBaseLineFit[uSyst] || !HistoToFit[uSyst] || FullCkForBaseline[uSyst])
            continue;
        if (!HistoToFit[uSyst])
            continue;
        ...
        if (FitBL[uSyst])
            delete FitBL[uSyst];
        FitBL[uSyst] = new TF1(TString::Format("FitBL%u_%p", uSyst, this), "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x",
                               FitRange[uSyst][kl], FitRange[uSyst][kmax]);
        if (FixPar[uSyst][p_a]) {
            FitBL[uSyst]->FixParameter(0, ParValue[uSyst][p_a]);
        } else {
            FitBL[uSyst]->SetParameter(0, ParValue[uSyst][p_a]);
            FitBL[uSyst]->SetParLimits(0, ParDownLimit[uSyst][p_a], ParUpLimit[uSyst][p_a]);
        }
        if (FixPar[uSyst][p_b]) {
            FitBL[uSyst]->FixParameter(1, ParValue[uSyst][p_b]);
        } else {
            FitBL[uSyst]->SetParameter(1, ParValue[uSyst][p_b]);
            FitBL[uSyst]->SetParLimits(1, ParDownLimit[uSyst][p_b], ParUpLimit[uSyst][p_b]);
        }
        if (FixPar[uSyst][p_c]) {
            FitBL[uSyst]->FixParameter(2, ParValue[uSyst][p_c]);
        } else {
            FitBL[uSyst]->SetParameter(2, ParValue[uSyst][p_c]);
            FitBL[uSyst]->SetParLimits(2, ParDownLimit[uSyst][p_c], ParUpLimit[uSyst][p_c]);
        }
        if (FixPar[uSyst][p_3]) {
            FitBL[uSyst]->FixParameter(3, ParValue[uSyst][p_3]);
        } else {
            FitBL[uSyst]->SetParameter(3, ParValue[uSyst][p_3]);
            FitBL[uSyst]->SetParLimits(3, ParDownLimit[uSyst][p_3], ParUpLimit[uSyst][p_3]);
        }
        if (FixPar[uSyst][p_4]) {
            FitBL[uSyst]->FixParameter(4, ParValue[uSyst][p_4]);
        } else {
            FitBL[uSyst]->SetParameter(4, ParValue[uSyst][p_4]);
            FitBL[uSyst]->SetParLimits(4, ParDownLimit[uSyst][p_4], ParUpLimit[uSyst][p_4]);
        }
        if (ShowFitInfo)
        ...
        FixParameter(uSyst, p_ab_6, FitBL[uSyst]->GetParameter(11));

        FixParameter(uSyst, p_kc, 0);

        /*
        TF1* FitBLold = new
        TF1(TString::Format("FitBLold%u",uSyst),"[0]+[1]*x+[2]*x*x",FitRange[uSyst][kl],FitRange[uSyst][kmax]);
        if(FixPar[uSyst][p_a]) {FitBLold->FixParameter(0, ParValue[uSyst][p_a]);}
        else{FitBLold->SetParameter(0, ParValue[uSyst][p_a]); FitBLold->SetParLimits(0, ParDownLimit[uSyst][p_a],
        ParUpLimit[uSyst][p_a]);} if(FixPar[uSyst][p_b]) {FitBLold->FixParameter(1, ParValue[uSyst][p_b]);}
        else{FitBLold->SetParameter(1, ParValue[uSyst][p_b]); FitBLold->SetParLimits(1, ParDownLimit[uSyst][p_b],
        ParUpLimit[uSyst][p_b]);} if(FixPar[uSyst][p_c]) {FitBLold->FixParameter(2, ParValue[uSyst][p_c]);}
        else{FitBLold->SetParameter(2, ParValue[uSyst][p_c]); FitBLold->SetParLimits(2, ParDownLimit[uSyst][p_c],
        ParUpLimit[uSyst][p_c]);} HistoToFit[uSyst]->Fit(FitBLold,"S, N, R, M");
    ...
    if (NumSourceSystems)
        SourceSystems = new DLM_CkDecomp *[NumSourceSystems];
    if (ParentSource) {
        delete[] ParentSource;
        ParentSource = NULL;
    }
    if (NumSourceSystems)
        ParentSource = new int[NumSourceSystems];
    // printf("SourceSystems=%p\n",SourceSystems);
    ...
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        ...
        */
        ...
        for (unsigned uSyst2 = 0; uSyst2 < MaxNumSyst; uSyst2++) {
            if (!SystemToFit[uSyst2])
                continue;
            SystemToFit[uSyst2]->GetName(buffer2);
            // in case we find in the map a relation between uSyst and uSyst2 -> we set this
            for (unsigned uSourceMap = 0; uSourceMap < NumSourceMapEntries; uSourceMap++) {
                if (strcmp(buffer, SameSourceMap[uSourceMap][0].Data()) == 0 &&
                    strcmp(buffer2, SameSourceMap[uSourceMap][1].Data()) == 0)
                    ParentSource[uActualSource] = uSyst2;
            }
        }
    ...
    for (unsigned uSourceMap = 0; uSourceMap < NumSourceMapEntries; uSourceMap++) {
        ...
        for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
            if (!SystemToFit[uSyst])
                continue;
            SystemToFit[uSyst]->GetName(buffer);
            if (strcmp(buffer, SameSourceMap[uSourceMap][1].Data()) == 0)
                ParentSource[uActualSource] = uSyst;
        }
    ...
    if (NumPotentialSystems)
        PotentialSystems = new DLM_CkDecomp *[NumPotentialSystems];
    if (ParentPotential) {
        delete[] ParentPotential;
        ParentPotential = NULL;
    }
    if (NumPotentialSystems)
        ParentPotential = new int[NumPotentialSystems];
    ...
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        ...
        for(unsigned uSyst2=0; uSyst2<MaxNumSyst; uSyst2++){
            if(!SystemToFit[uSyst2]) continue;
            SystemToFit[uSyst2]->GetName(buffer2);
            //if(strcmp(buffer,SamePotentialMap[uActualPotential][0].Data())==0)
        ParentPotential[uActualPotential]=uSyst2;
            //if(strcmp(buffer,SamePotentialMap[uActualPotential][1].Data())==0)
        ParentPotential[uActualPotential]=uSyst2; if(strcmp(buffer,buffer2)==0)
        ParentPotential[uActualPotential]=uSyst2;
        }
        */
        // find the source-parent if there is any
        for (unsigned uSyst2 = 0; uSyst2 < MaxNumSyst; uSyst2++) {
            ...
            for (unsigned uPotentialMap = 0; uPotentialMap < NumPotentialMapEntries; uPotentialMap++) {
                if (strcmp(buffer, SamePotentialMap[uPotentialMap][0].Data()) == 0 &&
                    strcmp(buffer2, SamePotentialMap[uPotentialMap][1].Data()) == 0)
                    ParentPotential[uActualPotential] = uSyst2;
            }
        }
    ...
    for (unsigned uPotentialMap = 0; uPotentialMap < NumPotentialMapEntries; uPotentialMap++) {
        ...
        for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
            if (!SystemToFit[uSyst])
                continue;
            SystemToFit[uSyst]->GetName(buffer);
            if (strcmp(buffer, SamePotentialMap[uPotentialMap][1].Data()) == 0)
                ParentPotential[uActualPotential] = uSyst;
        }
    ...
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        ...
        for (unsigned uBin = 0; uBin < NumOfBins; uBin++) {
            ...
            if (Momentum < FitRange[uSyst][kmin])
                TakeThisBin = false;
            else if (Momentum > FitRange[uSyst][kf] && Momentum < FitRange[uSyst][kl])
                TakeThisBin = false;
            else if (Momentum > FitRange[uSyst][kmax])
                TakeThisBin = false;
            else if (SeparateBaseLineFit[uSyst] && Momentum > FitRange[uSyst][kf])
                TakeThisBin = false;
            if (!TakeThisBin)
                continue;
            NumBinsGlobal++;
    ...
    if (HistoGlobal)
        delete HistoGlobal;
    HistoGlobal =
        new TH1F(TString::Format("HistoGlobal%p", this), TString::Format("HistoGlobal%p", this), NumBinsGlobal, 0, 1);
    if (FitGlobal)
        delete FitGlobal;
    FitGlobal = new TF1(TString::Format("FitGlobal%p", this), this, &DLM_Fitter1::EvalGlobal, 0, 1,
                        ActualNumSyst * NumPar, "DLM_Fitter1", "EvalGlobal");
    ...
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        ...
        for (unsigned uBin = 0; uBin < NumOfBins; uBin++) {
            ...
            else if (SeparateBaseLineFit[uSyst] && Momentum > FitRange[uSyst][kf] && FullCkForBaseline[uSyst] == false)
                TakeThisBin = false;
        ...
        for (unsigned uPar = 0; uPar < NumPar; uPar++) {
            ...
            if (FixPar[uSyst][uPar]) {
                ...
                // ParDownLimit[uSyst][uPar], ParUpLimit[uSyst][uPar]);
...
double DLM_Fitter1::EvalGlobal(double *xVal, double *Pars) {
    ...
    for (unsigned uSyst = 0; uSyst < MaxNumSyst; uSyst++) {
        ...
        if (GlobalBin < CumulativeNumBinsSyst[uSyst]) {
            WhichSyst = uSyst;
            break;
        }
    }

    if (!SystemToFit[WhichSyst])
        return 0;
    ...
    */
    ...
    for (unsigned uSource = 0; uSource < NumSourceSystems; uSource++) {
        ...
        // this is quite badly implemented! The idea is to check if there are more than 1 source parameters, however at
        // the moment I only check the main system, but there is no check if all systems are defined equivalently!
        // if(!FixPar[0][p_sor1])
    ...
    */
    for (unsigned uPotential = 0; uPotential < NumPotentialSystems; uPotential++) {
        for (unsigned uPar = 0; uPar < PotentialSystems[uPotential]->GetCk()->GetNumPotPar(); uPar++) {
            PotentialSystems[uPotential]->GetCk()->SetPotPar(
                uPar, Pars[ParentPotential[uPotential] * NumPar + p_pot0 + uPar]);
            // printf(" uPotential=%u; uPar=%u;  -->
    ...
    double BlVal;
    if (TypeMultBl == 0) {
        BlVal = Pars[WhichSyst * NumPar + p_a] + Pars[WhichSyst * NumPar + p_b] * Momentum +
                Pars[WhichSyst * NumPar + p_c] * Momentum * Momentum +
                Pars[WhichSyst * NumPar + p_3] * pow(Momentum, 3.) + Pars[WhichSyst * NumPar + p_4] * pow(Momentum, 4.);
    } else {
        BlVal =
            Pars[WhichSyst * NumPar + p_a] *
            (1. + Pars[WhichSyst * NumPar + p_b] * Momentum + Pars[WhichSyst * NumPar + p_c] * Momentum * Momentum +
             Pars[WhichSyst * NumPar + p_3] * pow(Momentum, 3.) + Pars[WhichSyst * NumPar + p_4] * pow(Momentum, 4.));
    }
    ...
    double AddBlVal;
    if (TypeAddBl == 0) {
        AddBlVal = Pars[WhichSyst * NumPar + p_ab_0] + Pars[WhichSyst * NumPar + p_ab_1] * Momentum +
                   Pars[WhichSyst * NumPar + p_ab_2] * Momentum * Momentum +
                   Pars[WhichSyst * NumPar + p_ab_3] * pow(Momentum, 3.) +
                   Pars[WhichSyst * NumPar + p_ab_4] * pow(Momentum, 4.) +
                   Pars[WhichSyst * NumPar + p_ab_5] * pow(Momentum, 5.) +
                   Pars[WhichSyst * NumPar + p_ab_6] * pow(Momentum, 6.);
    } else {
        AddBlVal = Pars[WhichSyst * NumPar + p_ab_0] * (1. + Pars[WhichSyst * NumPar + p_ab_1] * Momentum +
                                                        Pars[WhichSyst * NumPar + p_ab_2] * Momentum * Momentum +
                                                        Pars[WhichSyst * NumPar + p_ab_3] * pow(Momentum, 3.) +
                                                        Pars[WhichSyst * NumPar + p_ab_4] * pow(Momentum, 4.) +
                                                        Pars[WhichSyst * NumPar + p_ab_5] * pow(Momentum, 5.) +
    ...
    // this is here to make sure that we do not get an unphysical correlation function. If we do we put a HUGE value to
    // CkVal to make the chi2 very bad so that the fitter eventually rejects such combinations.
    if (RemoveNegCk) {
        // does not really work yet
        double CkMain = SystemToFit[WhichSyst]->EvalMain(Momentum);
        // if(CkMain<0) CkVal-=fabs(CkMain*1000);
        if (CkMain < 0)
            CkVal -= (exp(-CkMain * 32) - 1);
        // CkVal=-1e16;

        // printf("SystemToFit[WhichSyst]->EvalMain(%.3f)=%.3f\n", Momentum,
        // SystemToFit[WhichSyst]->EvalMain(Momentum));
    }
...
DLM_Fitter2::~DLM_Fitter2() {
    ...
    if (StartAddBlPars) {
        delete[] StartAddBlPars;
        StartAddBlPars = NULL;
    }
    if (StartMultBlPars) {
        delete[] StartMultBlPars;
        StartMultBlPars = NULL;
    }
}
...
void DLM_Fitter2::SetUpAddBl(const TString &WhichSyst, const fBlFunction &TYPE, const int &Info) {
    ...
    case f_spline3:
        ...
        break;
    default:
        printf("\033[1;33mWARNING:\033[0m The function TYPE passed to DLM_Fitter2 is unknown\n");
        return;
    }
    // update the number of parameters
    CurrentNumPars -= NumAddBlPars[SystemID];
...
void DLM_Fitter2::SetPolParX(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichPar,
                             const double &Value) {}
void DLM_Fitter2::FixPolParX(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichPar,
                             const double &Value) {}
void DLM_Fitter2::SetLimitPolParX(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichPar,
                                  const double &down, const double &up) {}
void DLM_Fitter2::SetPolParY(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichPar,
                             const double &Value) {}
void DLM_Fitter2::FixPolParY(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichPar,
                             const double &Value) {}
void DLM_Fitter2::SetLimitPolParY(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichPar,
                                  const double &down, const double &up) {}

void DLM_Fitter2::SetSplineKnotX(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichKnot,
                                 const double &Value) {}
void DLM_Fitter2::FixSplineKnotX(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichKnot,
                                 const double &Value) {}
void DLM_Fitter2::SetLimitSplineKnotX(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichKnot,
                                      const double &down, const double &up) {}
void DLM_Fitter2::SetSplineKnotY(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichKnot,
                                 const double &Value) {}
void DLM_Fitter2::FixSplineKnotY(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichKnot,
                                 const double &Value) {}
void DLM_Fitter2::SetLimitSplineKnotY(const TString &WhichSyst, const fBlType &WhichBl, const int &WhichKnot,
                                      const double &down, const double &up) {}
