...
double GeneralLednicky(const double &Momentum, const double &GaussR, const std::complex<double> &ScattLenSin,
                       const double &EffRangeSin, const std::complex<double> &ScattLenTri, const double &EffRangeTri,
                       const bool &SinOnly, const bool &QS, const bool &InverseScatLen = false);
...
// double Lednicky_gauss_pAL(const double &Momentum,  const double* SourcePar,const std::complex<double>& ScattLenSin,
// const double& EffRangeSin);
...
// double Lednicky_gauss_LAL(const double &Momentum,  const double* SourcePar,const std::complex<double>& ScattLenSin,
// const double& EffRangeSin);
