...
TFitResultPtr DLM_FitHisto(TH1 *h1, TF1 *f1, Option_t *option, Option_t *goption,
                           const ROOT::Math::MinimizerOptions *moption, Double_t xxmin, Double_t xxmax) {
...
// par[1] = sigma
// par[2] = Norm
double DlmPoisson(double *xVal, double *pars) { return DlmPoisson(*xVal, pars[0], pars[1], pars[2]); }
