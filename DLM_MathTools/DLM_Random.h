...
class DLM_Random {
  public:
    ...
    // from = 0
    int Integer(const int &to);
    // same as above, but from ---> to
    int Int(const int &from, const int &to);
    // from = 0
    int Int(const int &to);
    ...
    double Stable(const double &stability = 2, const double &location = 0, const double &scale = 1,
    ...
    double StableR(const unsigned short &dim, const double &stability = 2, const double &location = 0,
                   const double &scale = 1, const double &skewness = 0);
    double GaussR(const unsigned short &dim, const double *mean, const double *sigma);
    double CauchyR(const unsigned short &dim, const double *mean, const double *sigma);
    double StableR(const unsigned short &dim, const double *stability, const double *location, const double *scale,
    ...
    double StableDiffR(const unsigned short &dim, const double &stability = 2, const double &location = 0,
                       const double &scale = 1, const double &skewness = 0);
    double StableNolan(const unsigned short &dim, const double &stability = 2, const double &location = 0,
                       const double &scale = 1, const double &skewness = 0);
    double GaussDiffR(const unsigned short &dim, const double &mean1, const double &sigma1, const double &mean2,
                      const double &sigma2);
    double CauchyDiffR(const unsigned short &dim, const double &mean1, const double &sigma1, const double &mean2,
                       const double &sigma2);
    double StableDiffR(const unsigned short &dim, const double &stability1, const double &location1,
                       const double &scale1, const double &skewness1, const double &stability2, const double &location2,
                       const double &scale2, const double &skewness2);
    ...
    double StableDiffR(const unsigned short &dim, const double *stability, const double *location, const double *scale,
                       const double *skewness);
    double StableDiffR(const unsigned short &dim, const double &stability, const double *location, const double *scale,
                       const double *skewness);
