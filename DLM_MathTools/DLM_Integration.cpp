...
double FUNCTION(const double &x) {
    if (DLM_INT_TEMP_FUN1)
        return DLM_INT_TEMP_FUN1(x);
...
//
double DLM_INT_adaptiveSimpsonsAuxWiki(const double &a, const double &b, const double &epsilon, const double &S,
                                       const double &fa, const double &fb, const double &fc, const double &bottom) {
