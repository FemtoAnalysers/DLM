...
//       is to be read out by the the mother. Ones the mother creates all required funciton calls, it deletes the temp
//       files and continues the exectution.
class DLM_Fit {
  public:
    ...
    void SetFitRange(const unsigned &WhichData, const unsigned WhichAxis, const float &lower, const float &upper);
